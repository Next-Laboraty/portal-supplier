...
import NavbarSection from '../../organism/NavbarSection'
...
export default function MainPages({ children }) {
    return (
        <>
            ...
            {/* <div> */}
            {/* <h1 className="border bg-gray-600 text-white text-center">Copyright &copy; 2022 - Agung Priyatna MIT Licensed</h1> */}
            {/* </div> */}
                        ...
                        <div className="grid grid-cols-8 gap-6 md:gap-0">
                            ...
                            <div className="col-span-8 md:col-span-6 lg:col-span-5">
                                ...
                                <div className="pb-8 py-4 md:pl-16 border-t flex justify-between">
                                    <span>&copy; Onglai 2022  <span id="year" /> </span>
